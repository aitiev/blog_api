...
class RegisterSerializer(serializers.ModelSerializer):
    ...
    # Если кто-то использует адрес, то давть ошибку о повторном использовании
    ...
    # example for activation link
    # https://example.com/activate/0a0d5dfe-941d-473c-bab3-84ae02fb52a1/
